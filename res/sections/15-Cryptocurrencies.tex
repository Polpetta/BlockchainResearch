...
Blockchain database. The ``real'' privacy that Blockchain offer it is defined as
...
Therefore there is not any real account management, and no password. Recovering
a lost wallet is almost impossible, because if the asymmetric keys are lost
there is no way to reclaim the transactions, hence to reclaim the money. This
