...
This highlight the importance for a user to keep a backup of his keys. Wallet
...
keys to several vulnerabilities: first of all, the key could be stolen lost.
Even having the keys in any physical media without any protection system is
dangerous: as explained in\cite{eskandari15}, an attacker could spread a
malware able to send to him copies of users' private keys. Encrypting the keys
